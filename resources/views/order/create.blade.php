...
@section('content')
    <form action="{{ route('order.store') }}" method="POST" class="card p-4" style="margin-top:100px;">
        <input type="hidden" id="harga_produk" name="harga_produk" value="{{ old('harga_produk') }}">
        @csrf
